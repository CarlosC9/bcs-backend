...
# def validate_labels(wf_from_json, param_data, exit_on_error=True): # TODO borrar
#     """
...
# def validate_file_exists(inputs): # TODO pasar a métohd
#     """
...
def get_job_from_invocation(gi, invocation, step): # TODO no se usa?
    '''
